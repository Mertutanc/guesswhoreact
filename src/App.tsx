...
const subModesByMode: Record<GuessMode, SubModeOption[]> = {
  ...
  gameCharacter: [
    ...
    },
    {
      ...
      label: "RPG / Soulslike",
      emoji: "🗡️",
      description: "RPG, JRPG, CRPG ve Soulslike karakterleri.",
      playKind: "classic",
      tags: ["game:rpgSoulslike"],
    },
    {
      key: "nintendoPlatform",
      label: "Nintendo / Platform",
      emoji: "🍄",
      description: "Platform, maskot ve Nintendo ağırlıklı karakterler.",
      playKind: "classic",
      tags: ["game:nintendoPlatform"],
    },
    {
      key: "horror",
      label: "Korku",
      emoji: "👻",
      description: "Korku ve hayatta kalma oyunlarından karakterler.",
      playKind: "classic",
      tags: ["game:horror"],
    },
    {
      ...
      label: "FPS / Aksiyon",
      emoji: "🎯",
      description: "Shooter, askeri aksiyon ve hızlı çatışma karakterleri.",
      playKind: "classic",
      tags: ["game:fpsAction"],
    },
    {
      ...
      label: "Açık Dünya",
      emoji: "🗺️",
      description: "Açık dünya ve serbest keşif odaklı karakterler.",
      playKind: "classic",
      tags: ["game:openWorld"],
    },
    {
      ...
      label: "Indie",
      emoji: "💎",
      description: "Bağımsız oyunların kült karakterleri.",
      playKind: "classic",
      tags: ["game:indie"],
    },
    {
      ...
      label: "Dövüş",
      emoji: "🥊",
      description: "Fighting oyunları ve arena dövüşçüleri.",
      playKind: "classic",
      tags: ["game:fighting"],
    },
    {
      ...
      label: "Strateji / MOBA",
      emoji: "♟️",
      description: "MOBA, RTS ve taktiksel karakter havuzu.",
      playKind: "classic",
